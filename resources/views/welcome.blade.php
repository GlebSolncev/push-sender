    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const applicationServerKey =
                'BCOkjU5lMLi33eiL9eEpyfBBmHjvbp280UmRG3FU3ln4TOI9aDmiSwn2ohr9nzgqcwHGV4jL6nz_CMhalbSWVLk';
            ...
            sendPushButton.addEventListener('click', () =>
                navigator.serviceWorker.ready
                    ...
                    .then(subscription => {
                        ...
                        alert(JSON.stringify(Object.assign(jsonSubscription, { contentEncoding })))
