...
use App\Services\PushNotification\PreparePushService;
...
class PreparePushNotificationJob implements ShouldQueue
{
    ...
    public function __construct(
        ...
        protected PrepareQueryTypesEnum $typeEnum,
    ) {
    }
     ...
     * Execute the job.
     */
    public function handle(PreparePushService $service): void
    {
        $service->handle($this->typeEnum, $this->message);
//
//
//
//
